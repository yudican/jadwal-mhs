<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>data dosen</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-dosen-table params="{{request()->route()->getName()}}" />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' :
                            'Tambah'}} data dosen</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="kode_dosen" label="NIDN" />
                        <x-text-field type="text" name="nama_dosen" label="Nama Dosen" />
                        <x-text-field type="number" name="telepon_dosen" label="Telepon Dosen" />
                        <x-select name="jabatan_dosen" label="Jabatan Dosen">
                            <option value="">Select Jabatan Dosen</option>
                            <option value="Dosen Matakuliah">Dosen Matakuliah</option>
                            <option value="Dosen Pengganti">Dosen Pengganti</option>
                        </x-select>
                        <x-textarea type="textarea" name="alamat_dosen" label="Alamat Dosen" />
                    </div>

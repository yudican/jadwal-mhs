<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>data matakuliah</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-matakuliah-table params="{{request()->route()->getName()}}" />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' :
                            'Tambah'}} data matakuliah</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="kode_matakuliah" label="Kode Matakuliah" />
                        <x-text-field type="text" name="nama_matakuliah" label="Nama Matakuliah" />
                        <x-text-field type="number" name="jumlah_sks" label="Jumlah Sks" />
                        <x-select name="data_prodi_id" label="Pilih Prodi">
                            <option value="">Select Pilih Prodi</option>

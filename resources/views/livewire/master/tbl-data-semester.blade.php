<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>tbl data semester</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-semester-table params="{{request()->route()->getName()}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} tbl data semester</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="kode_semester" label="Kode Semester" />
<x-text-field type="text" name="nama_semester" label="Nama Semester" />
                    </div>
